...
proc b32     contains_1u32(rng1u32 r, u32 x);
...
proc b32     contains_1s32(rng1s32 r, s32 x);
...
proc b32     contains_1u64(rng1u64 r, u64 x);
...
proc b32     contains_1s64(rng1s64 r, s64 x);
...
proc b32     contains_1f32(rng1f32 r, f32 x);
...
proc b32     contains_1f64(rng1f64 r, f64 x);
...
proc b32     contains_2s16(rng2s16 r, vec2s16 x);
...
proc b32     contains_2s32(rng2s32 r, vec2s32 x);
...
proc b32     contains_2s64(rng2s64 r, vec2s64 x);
...
proc b32     contains_2f32(rng2f32 r, vec2f32 x);
