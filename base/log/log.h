...
#define LOG_INFO_COLOR    TERM_FOREGROUND_RGB(66, 190, 145)
...
typedef void Logger_Proc(rawptr data, Logger_Level level, string8 text, Logger_Options options, Code_Location loc);
